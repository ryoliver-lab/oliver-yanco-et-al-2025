...
wd=/Users/juliet/Documents/OliverLab/covid_paper/repositories/oliver-yanco-et-al-2025
src=$wd/src
db=$wd/processed_data/mosey_mod.db
export MOSEYENV_SRC=/Users/juliet/Documents/OliverLab/covid_paper/repositories/oliver-yanco-et-al-2025/src/mosey
...
export csvP=/Users/juliet/Documents/OliverLab/covid_paper/repositories/oliver-yanco-et-al-2025/gee_data/csvs_gee_ingest
# communicates which environmental data to annotate with in GEE
export envP=/Users/juliet/Documents/OliverLab/covid_paper/repositories/oliver-yanco-et-al-2025/ctfs/env.csv
# local folder that holds the annotated CSV files after GEE step is complete
export annoP=/Users/juliet/Documents/OliverLab/covid_paper/repositories/oliver-yanco-et-al-2025/gee_data/annotated
